...
type
  ...
  ///	object list</summary>
  ThpGenericObject = class(TPersistent)
  protected
    FIdentifier: string;
    FDescription: string;
  ...
  ThpGenericObjectList<T: constructor, ThpGenericObject> = class
  private
    FAscending: Boolean;
  ...
  protected
    ...
    procedure SetAscending(AValue: Boolean);
    procedure SetCaseSensitive(AValue: Boolean);
    procedure SetDuplicates(AValue: Boolean);
...
///	check</remarks>
procedure ThpGenericObjectList<T>.Delete(AIndex: Integer);
begin
